...
export default function AboutPage() {
  return (
    <div className="relative overflow-hidden bg-[#e8f4fc]">
      {/* Soft water-like atmosphere behind content (similar to Wix about page) */}
      <div
      ...
      {/* Intro + Why UV — two-column like the original */}
      ...
      <section className="relative py-16 sm:py-24">
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base leading-relaxed text-navy/65 sm:text-lg">
              {teamIntro.description}
            </p>
          </div>

          <ul className="mx-auto mt-14 grid max-w-6xl gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
